...
document.getElementById("submit_report").onclick = function () {
  ...
  document.getElementById("report_info_number").innerHTML =
    " Amount of Present students: " + notHere;
  ...
  document.getElementById('Absent').innerHTML = "Absent Students:" + hereStudents;
  document.getElementById('Absentnum').innerHTML = "Amount of Absent Students:" + hereStudents.length;
};
